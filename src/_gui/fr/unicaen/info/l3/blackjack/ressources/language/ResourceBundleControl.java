/*
 * Classe copier du lien suivant :
 * <http://www.java2s.com/Code/Java/I18N/ReadResourceBundleswithcustomencodings.htm>.
 */
 ...
 * utilities like native2ascii to convert files. <p> <br> <p> Usage: For instance we want to load resource bundle "test"
 * from current deirectory and use english locale. If locale not found, we will use default file (and ignore default
 * locale). </p>
 * <pre>
 * URLClassLoader loader = new URLClassLoader(new URL[] { new File(&quot;.&quot;).toURI().toURL() });
 *
 * ResourceBundle rb = ResourceBundle.getBundle(&quot;test&quot;, Locale.ENGLISH, loader, new
